Hello! In this subfolder you can see all the files that i used for the making of this project, **exept for credential files, in order to keep everything secured.**
